...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.35]{img/writepost.PNG}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.30]{img/following.PNG}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.30]{img/top.PNG}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.55]{img/saved.PNG}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{img/userprofile.PNG}
